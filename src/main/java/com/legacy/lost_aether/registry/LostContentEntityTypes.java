...
{
	public static final EntityType<AerwhaleKingEntity> AERWHALE_KING = buildEntity("aerwhale_king", EntityType.Builder.create(AerwhaleKingEntity::new, EntityClassification.MONSTER).size(4.0F, 4.0F));
