...
public class GuiAetherMenu extends GuiScreen implements GuiYesNoCallback
{
	...
	public void initGui()
	{
		...
		this.buttonList.add(new GuiAetherButton(0, width / margin, j + 72, I18n.format("menu.options", new Object[0])));
		this.buttonList.add(new GuiAetherButton(6, width / margin, j + 48, I18n.format("fml.menu.mods")));
		this.buttonList.add(new GuiAetherButton(4, width / margin, j + 96, I18n.format("menu.quit", new Object[0])));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		this.drawCenteredString(this.fontRenderer, this.splashText, 5, -5, -256);
		GlStateManager.popMatrix();
		// drawFooter();
		...
		if (line != null)
		{
			this.drawString(this.fontRenderer, line, width - this.fontRenderer.getStringWidth(line) - 2, height - (2 * (this.fontRenderer.FONT_HEIGHT + 1)), -1);
		}
