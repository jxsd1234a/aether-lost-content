...
public class ModelKingAerwhale extends ModelBase
{
	...
	public ModelKingAerwhale()
	{
		...
		this.BottomPartMiddlebody.addBox(-12.0F, 5.0F, -15.0F, 24, 6, 26, 0.0F);
		this.FrontBody = new ModelRenderer(this, 0, 141);
		this.FrontBody.setRotationPoint(0.0F, 0.9F, 0.0F);
		this.FrontBody.addBox(-11.5F, -1.0F, -0.5F, 19, 5, 21, 0.0F);
		...
		this.Crown1.addBox(-4.0F, -5.0F, -4.0F, 8, 5, 8, 0.0F);
		...
		this.BackfinLeft.addBox(-4.0F, 0.0F, -6.0F, 13, 3, 24, 0.0F);
		...
		this.BackfinRight.addBox(-11.0F, 0.0F, -6.0F, 15, 3, 24, 0.0F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
    	...
    	this.LeftFin.rotateAngleZ = (MathHelper.cos(ageInTicks * 0.05F) * 0.1F);
    	this.RightFin.rotateAngleZ = (MathHelper.cos(ageInTicks * 0.05F) * -0.1F);
    	...
    	EntityKingAerwhale whaleBoss = (EntityKingAerwhale)entityIn;
